...
function loadedcheck() {
  ...
  $('#loader').addClass('out').stop().animate({
    opacity: 0
  }, {
    duration: outtime * 1200,
    easing: 'easeOutQuart',
    complete: function complete() {
  ...
  setTimeout(function () {
    ...
    var scrollAnimationTarget2 = document.querySelectorAll('[data-trigger],[data-anim]'); //Nodelist

    var scrollAnimationTargetArr2 = Array.prototype.slice.call(scrollAnimationTarget2); //Array
